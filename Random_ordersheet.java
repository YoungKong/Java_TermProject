...
public class Random_ordersheet extends JPanel{
	...
	public void paint(Graphics g) {
		...
		if(level==3) {
			...
			g.drawImage(bottombun,40,180,this);
			g.drawImage(random1,40,165,this);
			g.drawImage(random2,40,145,this);
			g.drawImage(random3,40,135,this);
			g.drawImage(random4,40,115,this);
			g.drawImage(random5,40,95,this);
			g.drawImage(topbun,40,35,this);
			...
			g.drawImage(bottombun,40,180,this);
			g.drawImage(random1,40,170,this);
			g.drawImage(random2,40,155,this);
			g.drawImage(random3,40,140,this);
			g.drawImage(random4,40,125,this);
			g.drawImage(topbun,40,70,this);
			...
			g.drawImage(random1,40,165,this);
			g.drawImage(random2,40,145,this);
			g.drawImage(random3,40,125,this);
			g.drawImage(topbun,40,65,this);
