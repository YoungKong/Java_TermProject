...
public class TabbedPane1 extends JPanel{
	...
	public TabbedPane1() {
		...
		lt1=new JLabel("상, 중, 하로 나뉘며, 난이도가 높을수록 주어진 제한 시간이 줄어들고,");
		lt2=new JLabel("다양한 재료가 조합된 만들기 어려운 햄버거가 등장합니다.");
		rule=new JLabel("▷ 규칙");		
		...
		rt4=new JLabel("4. 햄버거가 완성되면 키보드의 Enter 버튼을 눌러 손님에게 전달해주세요.");
